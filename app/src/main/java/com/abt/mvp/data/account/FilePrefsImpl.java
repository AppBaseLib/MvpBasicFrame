 ...
 * 文件存储
 */
public class FilePrefsImpl implements FilePrefsHelper {
	...
	public FilePrefsImpl() {
		mSharedPreferences = MvpApplication.getAppContext().getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE);
	}

	public static synchronized FilePrefsHelper getInstance() {
		if (mPre == null) {
			mPre = new FilePrefsImpl();
		}
		return mPre;
	}
